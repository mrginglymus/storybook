...
export const enrichCsfMeta = (csf: CsfFile, csfSource: CsfFile, options?: EnrichCsfOptions): void => {
...
export const enrichCsf = async (csf: CsfFile, csfSource: CsfFile, options?: EnrichCsfOptions): Promise<void> => {
