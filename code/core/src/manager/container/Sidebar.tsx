...
const Sidebar: React.MemoExoticComponent<({ onMenuClick }: SidebarProps) => React.JSX.Element> = React.memo(function Sideber({ onMenuClick }: SidebarProps): React.JSX.Element {
