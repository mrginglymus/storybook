...
export const ErrorNode = ({ name, message }: { name: string; message: string }): React.JSX.Element => {
  const colors = useThemeColors();
  return (
...
export const RegExpNode = ({ flags, source }: { flags: string; source: string }): React.JSX.Element => {
  const colors = useThemeColors();
  return (
