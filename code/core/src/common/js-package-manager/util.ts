...
export const parsePositiveIntegerConfigValue = (value: string | null | undefined): number | null => {
...
export const getAgeInMinutes = (publishedAt: Date, now: Date = new Date()): number => {
...
export function getVitestStorybookRunCommand(packageManager: JsPackageManager, file?: string): string {
...
export const getStorybookRerunInstruction = (installContext: StorybookInstallContext): "Please rerun Storybook creation with:" | "Please rerun the Storybook upgrade with:" => {
