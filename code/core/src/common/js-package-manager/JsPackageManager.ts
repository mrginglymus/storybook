...
const indentSymbol: unique symbol = Symbol('indent');
...
export abstract class JsPackageManager {
  ...
  static readonly latestVersionCache: Map<string, string | null> = new Map<string, string | null>();

  /** Cache for installed version results to avoid repeated file system calls. */
  static readonly installedVersionCache: Map<string, string | null> = new Map<string, string | null>();

  /** Cache for package.json files to avoid repeated file system calls. */
  static readonly packageJsonCache: Map<string, PackageJsonWithIndent> = new Map<string, PackageJsonWithIndent>();
  ...
  writePackageJson(packageJson: PackageJson, directory: string = this.cwd): void {
