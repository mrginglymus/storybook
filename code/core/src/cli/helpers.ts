 ...
 */
export async function getVersionSafe(packageManager: JsPackageManager, packageName: string): Promise<string | undefined> {
  try {
...
export async function adjustTemplate(templatePath: string, templateData: Record<string, any>): Promise<void> {
