...
export const babel = async (_: unknown, options: Options): Promise<{
...
export const logLevel = (previous: any, options: Options): any => previous || options.loglevel || 'info';
...
export const typescript = () => ({
  ...
  reactDocgenTypescriptOptions: {
    ...
    propFilter: (prop: any): boolean => (prop.parent ? !/node_modules/.test(prop.parent.fileName) : true),
...
export const experimental_serverAPI = (extension: Record<string, Function>, options: Options): {
  removeAddon: typeof removeAddonBase;
} => {
