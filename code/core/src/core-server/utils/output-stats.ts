...
export async function outputStats(directory: string, previewStats?: any, managerStats?: any): Promise<void> {
  if (previewStats) {
...
export const writeStats = async (directory: string, name: string, stats: Stats): Promise<string> => {
